...
## Project Structure
    ...
    ├── testapiautoconnecto_76273  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_76273`
...
2. Clone this repo and `cd testapiautoconnecto_76273`
